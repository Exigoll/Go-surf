...
export const path = {
	...
	/*путь к папке /src с исходными файлами которые нужно скопировать: ${srcFolder} - папка с исходниками;/files - папка с файлами; /** - проверяем файлы в любых вложенных папках внутри папки /files; /*.* - проверяет все файлы с любыми расширенями*/
	src: {
